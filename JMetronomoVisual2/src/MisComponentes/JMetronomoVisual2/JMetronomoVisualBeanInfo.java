 ...
 * @author usuario
 */
public class JMetronomoVisualBeanInfo extends SimpleBeanInfo {

    // Bean descriptor//GEN-FIRST:BeanDescriptor
    /*lazy BeanDescriptor*/
    private static BeanDescriptor getBdescriptor(){
        BeanDescriptor beanDescriptor = new BeanDescriptor  ( MisComponentes.JMetronomoVisual2.JMetronomoVisual.class , null ); // NOI18N//GEN-HEADEREND:BeanDescriptor
    ...
    private static final int PROPERTY_cuentaAtras = 19;
    ...
    private static final int PROPERTY_pulsoActual = 81;
    private static final int PROPERTY_pulsos = 82;
    private static final int PROPERTY_pulsosPorMinuto = 83;
    ...
    private static PropertyDescriptor[] getPdescriptor(){
        ...
        try {
            properties[PROPERTY_accessibleContext] = new PropertyDescriptor ( "accessibleContext", MisComponentes.JMetronomoVisual2.JMetronomoVisual.class, "getAccessibleContext", null ); // NOI18N
            properties[PROPERTY_actionMap] = new PropertyDescriptor ( "actionMap", MisComponentes.JMetronomoVisual2.JMetronomoVisual.class, "getActionMap", "setActionMap" ); // NOI18N
            properties[PROPERTY_alignmentX] = new PropertyDescriptor ( "alignmentX", MisComponentes.JMetronomoVisual2.JMetronomoVisual.class, "getAlignmentX", "setAlignmentX" ); // NOI18N
            properties[PROPERTY_alignmentY] = new PropertyDescriptor ( "alignmentY", MisComponentes.JMetronomoVisual2.JMetronomoVisual.class, "getAlignmentY", "setAlignmentY" ); // NOI18N
            properties[PROPERTY_ancestorListeners] = new PropertyDescriptor ( "ancestorListeners", MisComponentes.JMetronomoVisual2.JMetronomoVisual.class, "getAncestorListeners", null ); // NOI18N
            properties[PROPERTY_autoscrolls] = new PropertyDescriptor ( "autoscrolls", MisComponentes.JMetronomoVisual2.JMetronomoVisual.class, "getAutoscrolls", "setAutoscrolls" ); // NOI18N
            properties[PROPERTY_background] = new PropertyDescriptor ( "background", MisComponentes.JMetronomoVisual2.JMetronomoVisual.class, "getBackground", "setBackground" ); // NOI18N
            properties[PROPERTY_backgroundSet] = new PropertyDescriptor ( "backgroundSet", MisComponentes.JMetronomoVisual2.JMetronomoVisual.class, "isBackgroundSet", null ); // NOI18N
            properties[PROPERTY_baselineResizeBehavior] = new PropertyDescriptor ( "baselineResizeBehavior", MisComponentes.JMetronomoVisual2.JMetronomoVisual.class, "getBaselineResizeBehavior", null ); // NOI18N
            properties[PROPERTY_border] = new PropertyDescriptor ( "border", MisComponentes.JMetronomoVisual2.JMetronomoVisual.class, "getBorder", "setBorder" ); // NOI18N
            properties[PROPERTY_bounds] = new PropertyDescriptor ( "bounds", MisComponentes.JMetronomoVisual2.JMetronomoVisual.class, "getBounds", "setBounds" ); // NOI18N
            properties[PROPERTY_colorModel] = new PropertyDescriptor ( "colorModel", MisComponentes.JMetronomoVisual2.JMetronomoVisual.class, "getColorModel", null ); // NOI18N
            properties[PROPERTY_component] = new IndexedPropertyDescriptor ( "component", MisComponentes.JMetronomoVisual2.JMetronomoVisual.class, null, null, "getComponent", null ); // NOI18N
            properties[PROPERTY_componentCount] = new PropertyDescriptor ( "componentCount", MisComponentes.JMetronomoVisual2.JMetronomoVisual.class, "getComponentCount", null ); // NOI18N
            properties[PROPERTY_componentListeners] = new PropertyDescriptor ( "componentListeners", MisComponentes.JMetronomoVisual2.JMetronomoVisual.class, "getComponentListeners", null ); // NOI18N
            properties[PROPERTY_componentOrientation] = new PropertyDescriptor ( "componentOrientation", MisComponentes.JMetronomoVisual2.JMetronomoVisual.class, "getComponentOrientation", "setComponentOrientation" ); // NOI18N
            properties[PROPERTY_componentPopupMenu] = new PropertyDescriptor ( "componentPopupMenu", MisComponentes.JMetronomoVisual2.JMetronomoVisual.class, "getComponentPopupMenu", "setComponentPopupMenu" ); // NOI18N
            properties[PROPERTY_components] = new PropertyDescriptor ( "components", MisComponentes.JMetronomoVisual2.JMetronomoVisual.class, "getComponents", null ); // NOI18N
            properties[PROPERTY_containerListeners] = new PropertyDescriptor ( "containerListeners", MisComponentes.JMetronomoVisual2.JMetronomoVisual.class, "getContainerListeners", null ); // NOI18N
            properties[PROPERTY_cuentaAtras] = new PropertyDescriptor ( "cuentaAtras", MisComponentes.JMetronomoVisual2.JMetronomoVisual.class, "isCuentaAtras", "setCuentaAtras" ); // NOI18N
            properties[PROPERTY_cursor] = new PropertyDescriptor ( "cursor", MisComponentes.JMetronomoVisual2.JMetronomoVisual.class, "getCursor", "setCursor" ); // NOI18N
            properties[PROPERTY_cursorSet] = new PropertyDescriptor ( "cursorSet", MisComponentes.JMetronomoVisual2.JMetronomoVisual.class, "isCursorSet", null ); // NOI18N
            properties[PROPERTY_debugGraphicsOptions] = new PropertyDescriptor ( "debugGraphicsOptions", MisComponentes.JMetronomoVisual2.JMetronomoVisual.class, "getDebugGraphicsOptions", "setDebugGraphicsOptions" ); // NOI18N
            properties[PROPERTY_displayable] = new PropertyDescriptor ( "displayable", MisComponentes.JMetronomoVisual2.JMetronomoVisual.class, "isDisplayable", null ); // NOI18N
            properties[PROPERTY_doubleBuffered] = new PropertyDescriptor ( "doubleBuffered", MisComponentes.JMetronomoVisual2.JMetronomoVisual.class, "isDoubleBuffered", "setDoubleBuffered" ); // NOI18N
            properties[PROPERTY_dropTarget] = new PropertyDescriptor ( "dropTarget", MisComponentes.JMetronomoVisual2.JMetronomoVisual.class, "getDropTarget", "setDropTarget" ); // NOI18N
            properties[PROPERTY_enabled] = new PropertyDescriptor ( "enabled", MisComponentes.JMetronomoVisual2.JMetronomoVisual.class, "isEnabled", "setEnabled" ); // NOI18N
            properties[PROPERTY_focusable] = new PropertyDescriptor ( "focusable", MisComponentes.JMetronomoVisual2.JMetronomoVisual.class, "isFocusable", "setFocusable" ); // NOI18N
            properties[PROPERTY_focusCycleRoot] = new PropertyDescriptor ( "focusCycleRoot", MisComponentes.JMetronomoVisual2.JMetronomoVisual.class, "isFocusCycleRoot", "setFocusCycleRoot" ); // NOI18N
            properties[PROPERTY_focusCycleRootAncestor] = new PropertyDescriptor ( "focusCycleRootAncestor", MisComponentes.JMetronomoVisual2.JMetronomoVisual.class, "getFocusCycleRootAncestor", null ); // NOI18N
            properties[PROPERTY_focusListeners] = new PropertyDescriptor ( "focusListeners", MisComponentes.JMetronomoVisual2.JMetronomoVisual.class, "getFocusListeners", null ); // NOI18N
            properties[PROPERTY_focusOwner] = new PropertyDescriptor ( "focusOwner", MisComponentes.JMetronomoVisual2.JMetronomoVisual.class, "isFocusOwner", null ); // NOI18N
            properties[PROPERTY_focusTraversable] = new PropertyDescriptor ( "focusTraversable", MisComponentes.JMetronomoVisual2.JMetronomoVisual.class, "isFocusTraversable", null ); // NOI18N
            properties[PROPERTY_focusTraversalKeys] = new IndexedPropertyDescriptor ( "focusTraversalKeys", MisComponentes.JMetronomoVisual2.JMetronomoVisual.class, null, null, null, "setFocusTraversalKeys" ); // NOI18N
            properties[PROPERTY_focusTraversalKeysEnabled] = new PropertyDescriptor ( "focusTraversalKeysEnabled", MisComponentes.JMetronomoVisual2.JMetronomoVisual.class, "getFocusTraversalKeysEnabled", "setFocusTraversalKeysEnabled" ); // NOI18N
            properties[PROPERTY_focusTraversalPolicy] = new PropertyDescriptor ( "focusTraversalPolicy", MisComponentes.JMetronomoVisual2.JMetronomoVisual.class, "getFocusTraversalPolicy", "setFocusTraversalPolicy" ); // NOI18N
            properties[PROPERTY_focusTraversalPolicyProvider] = new PropertyDescriptor ( "focusTraversalPolicyProvider", MisComponentes.JMetronomoVisual2.JMetronomoVisual.class, "isFocusTraversalPolicyProvider", "setFocusTraversalPolicyProvider" ); // NOI18N
            properties[PROPERTY_focusTraversalPolicySet] = new PropertyDescriptor ( "focusTraversalPolicySet", MisComponentes.JMetronomoVisual2.JMetronomoVisual.class, "isFocusTraversalPolicySet", null ); // NOI18N
            properties[PROPERTY_font] = new PropertyDescriptor ( "font", MisComponentes.JMetronomoVisual2.JMetronomoVisual.class, "getFont", "setFont" ); // NOI18N
            properties[PROPERTY_fontSet] = new PropertyDescriptor ( "fontSet", MisComponentes.JMetronomoVisual2.JMetronomoVisual.class, "isFontSet", null ); // NOI18N
            properties[PROPERTY_foreground] = new PropertyDescriptor ( "foreground", MisComponentes.JMetronomoVisual2.JMetronomoVisual.class, "getForeground", "setForeground" ); // NOI18N
            properties[PROPERTY_foregroundSet] = new PropertyDescriptor ( "foregroundSet", MisComponentes.JMetronomoVisual2.JMetronomoVisual.class, "isForegroundSet", null ); // NOI18N
            properties[PROPERTY_graphics] = new PropertyDescriptor ( "graphics", MisComponentes.JMetronomoVisual2.JMetronomoVisual.class, "getGraphics", null ); // NOI18N
            properties[PROPERTY_graphicsConfiguration] = new PropertyDescriptor ( "graphicsConfiguration", MisComponentes.JMetronomoVisual2.JMetronomoVisual.class, "getGraphicsConfiguration", null ); // NOI18N
            properties[PROPERTY_height] = new PropertyDescriptor ( "height", MisComponentes.JMetronomoVisual2.JMetronomoVisual.class, "getHeight", null ); // NOI18N
            properties[PROPERTY_hierarchyBoundsListeners] = new PropertyDescriptor ( "hierarchyBoundsListeners", MisComponentes.JMetronomoVisual2.JMetronomoVisual.class, "getHierarchyBoundsListeners", null ); // NOI18N
            properties[PROPERTY_hierarchyListeners] = new PropertyDescriptor ( "hierarchyListeners", MisComponentes.JMetronomoVisual2.JMetronomoVisual.class, "getHierarchyListeners", null ); // NOI18N
            properties[PROPERTY_ignoreRepaint] = new PropertyDescriptor ( "ignoreRepaint", MisComponentes.JMetronomoVisual2.JMetronomoVisual.class, "getIgnoreRepaint", "setIgnoreRepaint" ); // NOI18N
            properties[PROPERTY_inheritsPopupMenu] = new PropertyDescriptor ( "inheritsPopupMenu", MisComponentes.JMetronomoVisual2.JMetronomoVisual.class, "getInheritsPopupMenu", "setInheritsPopupMenu" ); // NOI18N
            properties[PROPERTY_inputContext] = new PropertyDescriptor ( "inputContext", MisComponentes.JMetronomoVisual2.JMetronomoVisual.class, "getInputContext", null ); // NOI18N
            properties[PROPERTY_inputMap] = new PropertyDescriptor ( "inputMap", MisComponentes.JMetronomoVisual2.JMetronomoVisual.class, "getInputMap", null ); // NOI18N
            properties[PROPERTY_inputMethodListeners] = new PropertyDescriptor ( "inputMethodListeners", MisComponentes.JMetronomoVisual2.JMetronomoVisual.class, "getInputMethodListeners", null ); // NOI18N
            properties[PROPERTY_inputMethodRequests] = new PropertyDescriptor ( "inputMethodRequests", MisComponentes.JMetronomoVisual2.JMetronomoVisual.class, "getInputMethodRequests", null ); // NOI18N
            properties[PROPERTY_inputVerifier] = new PropertyDescriptor ( "inputVerifier", MisComponentes.JMetronomoVisual2.JMetronomoVisual.class, "getInputVerifier", "setInputVerifier" ); // NOI18N
            properties[PROPERTY_insets] = new PropertyDescriptor ( "insets", MisComponentes.JMetronomoVisual2.JMetronomoVisual.class, "getInsets", null ); // NOI18N
            properties[PROPERTY_keyListeners] = new PropertyDescriptor ( "keyListeners", MisComponentes.JMetronomoVisual2.JMetronomoVisual.class, "getKeyListeners", null ); // NOI18N
            properties[PROPERTY_layout] = new PropertyDescriptor ( "layout", MisComponentes.JMetronomoVisual2.JMetronomoVisual.class, "getLayout", "setLayout" ); // NOI18N
            properties[PROPERTY_lightweight] = new PropertyDescriptor ( "lightweight", MisComponentes.JMetronomoVisual2.JMetronomoVisual.class, "isLightweight", null ); // NOI18N
            properties[PROPERTY_locale] = new PropertyDescriptor ( "locale", MisComponentes.JMetronomoVisual2.JMetronomoVisual.class, "getLocale", "setLocale" ); // NOI18N
            properties[PROPERTY_location] = new PropertyDescriptor ( "location", MisComponentes.JMetronomoVisual2.JMetronomoVisual.class, "getLocation", "setLocation" ); // NOI18N
            properties[PROPERTY_locationOnScreen] = new PropertyDescriptor ( "locationOnScreen", MisComponentes.JMetronomoVisual2.JMetronomoVisual.class, "getLocationOnScreen", null ); // NOI18N
            properties[PROPERTY_managingFocus] = new PropertyDescriptor ( "managingFocus", MisComponentes.JMetronomoVisual2.JMetronomoVisual.class, "isManagingFocus", null ); // NOI18N
            properties[PROPERTY_maximumSize] = new PropertyDescriptor ( "maximumSize", MisComponentes.JMetronomoVisual2.JMetronomoVisual.class, "getMaximumSize", "setMaximumSize" ); // NOI18N
            properties[PROPERTY_maximumSizeSet] = new PropertyDescriptor ( "maximumSizeSet", MisComponentes.JMetronomoVisual2.JMetronomoVisual.class, "isMaximumSizeSet", null ); // NOI18N
            properties[PROPERTY_minimumSize] = new PropertyDescriptor ( "minimumSize", MisComponentes.JMetronomoVisual2.JMetronomoVisual.class, "getMinimumSize", "setMinimumSize" ); // NOI18N
            properties[PROPERTY_minimumSizeSet] = new PropertyDescriptor ( "minimumSizeSet", MisComponentes.JMetronomoVisual2.JMetronomoVisual.class, "isMinimumSizeSet", null ); // NOI18N
            properties[PROPERTY_mouseListeners] = new PropertyDescriptor ( "mouseListeners", MisComponentes.JMetronomoVisual2.JMetronomoVisual.class, "getMouseListeners", null ); // NOI18N
            properties[PROPERTY_mouseMotionListeners] = new PropertyDescriptor ( "mouseMotionListeners", MisComponentes.JMetronomoVisual2.JMetronomoVisual.class, "getMouseMotionListeners", null ); // NOI18N
            properties[PROPERTY_mousePosition] = new PropertyDescriptor ( "mousePosition", MisComponentes.JMetronomoVisual2.JMetronomoVisual.class, "getMousePosition", null ); // NOI18N
            properties[PROPERTY_mouseWheelListeners] = new PropertyDescriptor ( "mouseWheelListeners", MisComponentes.JMetronomoVisual2.JMetronomoVisual.class, "getMouseWheelListeners", null ); // NOI18N
            properties[PROPERTY_name] = new PropertyDescriptor ( "name", MisComponentes.JMetronomoVisual2.JMetronomoVisual.class, "getName", "setName" ); // NOI18N
            properties[PROPERTY_nextFocusableComponent] = new PropertyDescriptor ( "nextFocusableComponent", MisComponentes.JMetronomoVisual2.JMetronomoVisual.class, "getNextFocusableComponent", "setNextFocusableComponent" ); // NOI18N
            properties[PROPERTY_opaque] = new PropertyDescriptor ( "opaque", MisComponentes.JMetronomoVisual2.JMetronomoVisual.class, "isOpaque", "setOpaque" ); // NOI18N
            properties[PROPERTY_optimizedDrawingEnabled] = new PropertyDescriptor ( "optimizedDrawingEnabled", MisComponentes.JMetronomoVisual2.JMetronomoVisual.class, "isOptimizedDrawingEnabled", null ); // NOI18N
            properties[PROPERTY_paintingForPrint] = new PropertyDescriptor ( "paintingForPrint", MisComponentes.JMetronomoVisual2.JMetronomoVisual.class, "isPaintingForPrint", null ); // NOI18N
            properties[PROPERTY_paintingTile] = new PropertyDescriptor ( "paintingTile", MisComponentes.JMetronomoVisual2.JMetronomoVisual.class, "isPaintingTile", null ); // NOI18N
            properties[PROPERTY_parent] = new PropertyDescriptor ( "parent", MisComponentes.JMetronomoVisual2.JMetronomoVisual.class, "getParent", null ); // NOI18N
            properties[PROPERTY_peer] = new PropertyDescriptor ( "peer", MisComponentes.JMetronomoVisual2.JMetronomoVisual.class, "getPeer", null ); // NOI18N
            properties[PROPERTY_preferredSize] = new PropertyDescriptor ( "preferredSize", MisComponentes.JMetronomoVisual2.JMetronomoVisual.class, "getPreferredSize", "setPreferredSize" ); // NOI18N
            properties[PROPERTY_preferredSizeSet] = new PropertyDescriptor ( "preferredSizeSet", MisComponentes.JMetronomoVisual2.JMetronomoVisual.class, "isPreferredSizeSet", null ); // NOI18N
            properties[PROPERTY_propertyChangeListeners] = new PropertyDescriptor ( "propertyChangeListeners", MisComponentes.JMetronomoVisual2.JMetronomoVisual.class, "getPropertyChangeListeners", null ); // NOI18N
            properties[PROPERTY_pulsoActual] = new PropertyDescriptor ( "pulsoActual", MisComponentes.JMetronomoVisual2.JMetronomoVisual.class, "getPulsoActual", null ); // NOI18N
            properties[PROPERTY_pulsoActual].setPreferred ( true );
            properties[PROPERTY_pulsos] = new PropertyDescriptor ( "pulsos", MisComponentes.JMetronomoVisual2.JMetronomoVisual.class, null, "setPulsos" ); // NOI18N
            properties[PROPERTY_pulsos].setPreferred ( true );
            properties[PROPERTY_pulsosPorMinuto] = new PropertyDescriptor ( "pulsosPorMinuto", MisComponentes.JMetronomoVisual2.JMetronomoVisual.class, null, "setPulsosPorMinuto" ); // NOI18N
            properties[PROPERTY_pulsosPorMinuto].setPreferred ( true );
            properties[PROPERTY_registeredKeyStrokes] = new PropertyDescriptor ( "registeredKeyStrokes", MisComponentes.JMetronomoVisual2.JMetronomoVisual.class, "getRegisteredKeyStrokes", null ); // NOI18N
            properties[PROPERTY_requestFocusEnabled] = new PropertyDescriptor ( "requestFocusEnabled", MisComponentes.JMetronomoVisual2.JMetronomoVisual.class, "isRequestFocusEnabled", "setRequestFocusEnabled" ); // NOI18N
            properties[PROPERTY_rootPane] = new PropertyDescriptor ( "rootPane", MisComponentes.JMetronomoVisual2.JMetronomoVisual.class, "getRootPane", null ); // NOI18N
            properties[PROPERTY_showing] = new PropertyDescriptor ( "showing", MisComponentes.JMetronomoVisual2.JMetronomoVisual.class, "isShowing", null ); // NOI18N
            properties[PROPERTY_size] = new PropertyDescriptor ( "size", MisComponentes.JMetronomoVisual2.JMetronomoVisual.class, "getSize", "setSize" ); // NOI18N
            properties[PROPERTY_toolkit] = new PropertyDescriptor ( "toolkit", MisComponentes.JMetronomoVisual2.JMetronomoVisual.class, "getToolkit", null ); // NOI18N
            properties[PROPERTY_toolTipText] = new PropertyDescriptor ( "toolTipText", MisComponentes.JMetronomoVisual2.JMetronomoVisual.class, "getToolTipText", "setToolTipText" ); // NOI18N
            properties[PROPERTY_topLevelAncestor] = new PropertyDescriptor ( "topLevelAncestor", MisComponentes.JMetronomoVisual2.JMetronomoVisual.class, "getTopLevelAncestor", null ); // NOI18N
            properties[PROPERTY_transferHandler] = new PropertyDescriptor ( "transferHandler", MisComponentes.JMetronomoVisual2.JMetronomoVisual.class, "getTransferHandler", "setTransferHandler" ); // NOI18N
            properties[PROPERTY_treeLock] = new PropertyDescriptor ( "treeLock", MisComponentes.JMetronomoVisual2.JMetronomoVisual.class, "getTreeLock", null ); // NOI18N
            properties[PROPERTY_UI] = new PropertyDescriptor ( "UI", MisComponentes.JMetronomoVisual2.JMetronomoVisual.class, "getUI", "setUI" ); // NOI18N
            properties[PROPERTY_UIClassID] = new PropertyDescriptor ( "UIClassID", MisComponentes.JMetronomoVisual2.JMetronomoVisual.class, "getUIClassID", null ); // NOI18N
            properties[PROPERTY_valid] = new PropertyDescriptor ( "valid", MisComponentes.JMetronomoVisual2.JMetronomoVisual.class, "isValid", null ); // NOI18N
            properties[PROPERTY_validateRoot] = new PropertyDescriptor ( "validateRoot", MisComponentes.JMetronomoVisual2.JMetronomoVisual.class, "isValidateRoot", null ); // NOI18N
            properties[PROPERTY_verifyInputWhenFocusTarget] = new PropertyDescriptor ( "verifyInputWhenFocusTarget", MisComponentes.JMetronomoVisual2.JMetronomoVisual.class, "getVerifyInputWhenFocusTarget", "setVerifyInputWhenFocusTarget" ); // NOI18N
            properties[PROPERTY_vetoableChangeListeners] = new PropertyDescriptor ( "vetoableChangeListeners", MisComponentes.JMetronomoVisual2.JMetronomoVisual.class, "getVetoableChangeListeners", null ); // NOI18N
            properties[PROPERTY_visible] = new PropertyDescriptor ( "visible", MisComponentes.JMetronomoVisual2.JMetronomoVisual.class, "isVisible", "setVisible" ); // NOI18N
            properties[PROPERTY_visibleRect] = new PropertyDescriptor ( "visibleRect", MisComponentes.JMetronomoVisual2.JMetronomoVisual.class, "getVisibleRect", null ); // NOI18N
            properties[PROPERTY_width] = new PropertyDescriptor ( "width", MisComponentes.JMetronomoVisual2.JMetronomoVisual.class, "getWidth", null ); // NOI18N
            properties[PROPERTY_x] = new PropertyDescriptor ( "x", MisComponentes.JMetronomoVisual2.JMetronomoVisual.class, "getX", null ); // NOI18N
            properties[PROPERTY_y] = new PropertyDescriptor ( "y", MisComponentes.JMetronomoVisual2.JMetronomoVisual.class, "getY", null ); // NOI18N
        }
    ...
    private static final int EVENT_JMetronomoVisualListener = 7;
    ...
    private static EventSetDescriptor[] getEdescriptor(){
        ...
        try {
            eventSets[EVENT_ancestorListener] = new EventSetDescriptor ( MisComponentes.JMetronomoVisual2.JMetronomoVisual.class, "ancestorListener", javax.swing.event.AncestorListener.class, new String[] {"ancestorAdded", "ancestorRemoved", "ancestorMoved"}, "addAncestorListener", "removeAncestorListener" ); // NOI18N
            eventSets[EVENT_componentListener] = new EventSetDescriptor ( MisComponentes.JMetronomoVisual2.JMetronomoVisual.class, "componentListener", java.awt.event.ComponentListener.class, new String[] {"componentResized", "componentMoved", "componentShown", "componentHidden"}, "addComponentListener", "removeComponentListener" ); // NOI18N
            eventSets[EVENT_containerListener] = new EventSetDescriptor ( MisComponentes.JMetronomoVisual2.JMetronomoVisual.class, "containerListener", java.awt.event.ContainerListener.class, new String[] {"componentAdded", "componentRemoved"}, "addContainerListener", "removeContainerListener" ); // NOI18N
            eventSets[EVENT_focusListener] = new EventSetDescriptor ( MisComponentes.JMetronomoVisual2.JMetronomoVisual.class, "focusListener", java.awt.event.FocusListener.class, new String[] {"focusGained", "focusLost"}, "addFocusListener", "removeFocusListener" ); // NOI18N
            eventSets[EVENT_hierarchyBoundsListener] = new EventSetDescriptor ( MisComponentes.JMetronomoVisual2.JMetronomoVisual.class, "hierarchyBoundsListener", java.awt.event.HierarchyBoundsListener.class, new String[] {"ancestorMoved", "ancestorResized"}, "addHierarchyBoundsListener", "removeHierarchyBoundsListener" ); // NOI18N
            eventSets[EVENT_hierarchyListener] = new EventSetDescriptor ( MisComponentes.JMetronomoVisual2.JMetronomoVisual.class, "hierarchyListener", java.awt.event.HierarchyListener.class, new String[] {"hierarchyChanged"}, "addHierarchyListener", "removeHierarchyListener" ); // NOI18N
            eventSets[EVENT_inputMethodListener] = new EventSetDescriptor ( MisComponentes.JMetronomoVisual2.JMetronomoVisual.class, "inputMethodListener", java.awt.event.InputMethodListener.class, new String[] {"inputMethodTextChanged", "caretPositionChanged"}, "addInputMethodListener", "removeInputMethodListener" ); // NOI18N
            eventSets[EVENT_JMetronomoVisualListener] = new EventSetDescriptor ( MisComponentes.JMetronomoVisual2.JMetronomoVisual.class, "JMetronomoVisualListener", MisComponentes.JMetronomoVisual2.JMetronomoVisualListener.class, new String[] {"metronomoPulso", "metronomoFin"}, "addJMetronomoVisualListener", "removeJMetronomoVisualListener" ); // NOI18N
            eventSets[EVENT_keyListener] = new EventSetDescriptor ( MisComponentes.JMetronomoVisual2.JMetronomoVisual.class, "keyListener", java.awt.event.KeyListener.class, new String[] {"keyTyped", "keyPressed", "keyReleased"}, "addKeyListener", "removeKeyListener" ); // NOI18N
            eventSets[EVENT_mouseListener] = new EventSetDescriptor ( MisComponentes.JMetronomoVisual2.JMetronomoVisual.class, "mouseListener", java.awt.event.MouseListener.class, new String[] {"mouseClicked", "mousePressed", "mouseReleased", "mouseEntered", "mouseExited"}, "addMouseListener", "removeMouseListener" ); // NOI18N
            eventSets[EVENT_mouseMotionListener] = new EventSetDescriptor ( MisComponentes.JMetronomoVisual2.JMetronomoVisual.class, "mouseMotionListener", java.awt.event.MouseMotionListener.class, new String[] {"mouseDragged", "mouseMoved"}, "addMouseMotionListener", "removeMouseMotionListener" ); // NOI18N
            eventSets[EVENT_mouseWheelListener] = new EventSetDescriptor ( MisComponentes.JMetronomoVisual2.JMetronomoVisual.class, "mouseWheelListener", java.awt.event.MouseWheelListener.class, new String[] {"mouseWheelMoved"}, "addMouseWheelListener", "removeMouseWheelListener" ); // NOI18N
            eventSets[EVENT_propertyChangeListener] = new EventSetDescriptor ( MisComponentes.JMetronomoVisual2.JMetronomoVisual.class, "propertyChangeListener", java.beans.PropertyChangeListener.class, new String[] {"propertyChange"}, "addPropertyChangeListener", "removePropertyChangeListener" ); // NOI18N
            eventSets[EVENT_vetoableChangeListener] = new EventSetDescriptor ( MisComponentes.JMetronomoVisual2.JMetronomoVisual.class, "vetoableChangeListener", java.beans.VetoableChangeListener.class, new String[] {"vetoableChange"}, "addVetoableChangeListener", "removeVetoableChangeListener" ); // NOI18N
        }
        catch(IntrospectionException e) {
            e.printStackTrace();
    ...
    private static final int METHOD_detener25 = 25;
    ...
    private static final int METHOD_iniciar68 = 68;
    ...
    private static final int METHOD_puestaCero107 = 107;
    ...
    private static MethodDescriptor[] getMdescriptor(){
        ...
        try {
            ...
            methods[METHOD_actionPerformed1] = new MethodDescriptor(MisComponentes.JMetronomoVisual2.JMetronomoVisual.class.getMethod("actionPerformed", new Class[] {java.awt.event.ActionEvent.class})); // NOI18N
            ...
            methods[METHOD_detener25] = new MethodDescriptor(MisComponentes.JMetronomoVisual2.JMetronomoVisual.class.getMethod("detener", new Class[] {})); // NOI18N
            methods[METHOD_detener25].setDisplayName ( "" );
            ...
            methods[METHOD_iniciar68] = new MethodDescriptor(MisComponentes.JMetronomoVisual2.JMetronomoVisual.class.getMethod("iniciar", new Class[] {})); // NOI18N
            methods[METHOD_iniciar68].setDisplayName ( "" );
            ...
            methods[METHOD_puestaCero107] = new MethodDescriptor(MisComponentes.JMetronomoVisual2.JMetronomoVisual.class.getMethod("puestaCero", new Class[] {})); // NOI18N
            methods[METHOD_puestaCero107].setDisplayName ( "" );
