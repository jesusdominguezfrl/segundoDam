...
//        myPCS.firePropertyChange("pulsoActual",old, pulsoActual);
    ...
    private void jCheckBoxCuentaAtrasActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jCheckBoxCuentaAtrasActionPerformed
        cuentaAtras = jCheckBoxCuentaAtras.isSelected();
        muestraVisor();
    }//GEN-LAST:event_jCheckBoxCuentaAtrasActionPerformed

    private void jSliderNumeroPulsosStateChanged(javax.swing.event.ChangeEvent evt) {//GEN-FIRST:event_jSliderNumeroPulsosStateChanged
        setPulsos(jSliderNumeroPulsos.getValue());
        muestraVisor();
    }//GEN-LAST:event_jSliderNumeroPulsosStateChanged

    private void jSliderPulsosMinutoStateChanged(javax.swing.event.ChangeEvent evt) {//GEN-FIRST:event_jSliderPulsosMinutoStateChanged
        setPulsosPorMinuto(jSliderPulsosMinuto.getValue());
    }//GEN-LAST:event_jSliderPulsosMinutoStateChanged
